...
void vendedor(struct Usuario usuarioAtual, struct Usuario usuarios[20], int indice, struct Produto produtos[20], int index2);                              // Interface para usuarios do tipo vendedores;
...
void printaStructProduto(struct Produto produtos[20], int index2);
        ...
        for (int i = 0; i <= 20; i++)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        vendedor(usuarioAtual, usuarios, indice, produtos, index2);
                        system("cls");
                    }
                    else
                    {
...
void vendedor(struct Usuario usuarioAtual, struct Usuario usuarios[20], int indice, struct Produto produtos[20], int index2)
{
    int contador = 0;
    while (contador == 0)
    {
        ...
        {
            printaStructProduto(produtos, index2);
            system("pause");
        }
        else if (escolha == 4)
        {
